...
TeamFinder — это платформа для поиска единомышленников для совместной работы над Pet-проектами. Сервис позволяет разработчикам, дизайнерам и другим специалистам публиковать идеи своих проектов, искать команду или откликаться на существующие предложения.
...
| **TASK_VERSION**      | Номер варианта вашего задания. Использу используется для определения набора HTML-шаблонов.                                                                          |
...
Для доступа в панель администратора создайте суперпользователя:
